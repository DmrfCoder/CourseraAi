...
from CarDetection.models.keras_yolo import yolo_boxes_to_corners
from CarDetection.yolo_utils import read_classes, read_anchors, generate_colors, preprocess_image, draw_boxes, \
    scale_boxes
...
def yolo_filter_boxes(box_confidence, boxes, box_class_probs, threshold=.6):
    ...
    box_class_probs -- tensor of shape (19, 19, 5, 80) c1,c2,c3...c80
    ...
    # (19, 19, 5, 80)
    box_scores = tf.multiply(box_confidence, box_class_probs)  # [score1,score2,....,score3]
    ### END CODE HERE ###
    ...
    ### START CODE HERE ### (≈ 1 line)
    # (19, 19, 5)，大于等于threshold为true，否则为false
...
def demo_yolo_non_max_suppression():
