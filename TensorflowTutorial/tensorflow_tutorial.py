...
def demo_cost():
    ...
    cost = cost2(logits, np.array([0, 0, 1, 1]))
    print("cost = " + str(cost))
...
def create_placeholders(n_x, n_y):
    ...
    X = tf.placeholder(dtype=tf.float32, shape=(12288, None))
...
if __name__ == '__main__':
    X_train, Y_train, X_test, Y_test, classes = my_load_dataset()
